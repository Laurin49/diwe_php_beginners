            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="index.php"
                           class="<?= urlIs('/php2023/php_for_beginners/index.php') ? 'bg-gray-900 text-white ' : 'text-gray-300' ?>
                                rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
                            Home
                        </a>
                        <a href="about.php"
                           class="<?= urlIs('/php2023/php_for_beginners/about.php') ? 'bg-gray-900 text-white ' : 'text-gray-300' ?>
                                rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
                            About
                        </a>
                        <a href="contact.php"
                           class="<?= urlIs('/php2023/php_for_beginners/contact.php') ? 'bg-gray-900 text-white ' : 'text-gray-300' ?>
                                rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
                            Contact
                        </a>
                    </div>
